...
**Version :** 4.0
**Mis à jour :** 13/05/2026 — architecture pools + standards QA + consolidation V2
...
- Les fourchettes N1 / N2 / N3 restent indicatives et adaptables selon le thème et le public ciblé.
...
└── _LIGNES/                        ← une ligne de production par quiz
    ...
    │
    ├── _CDM/                       ← cobaye A3 (traitement BIB) + A4 (pools)
    │   ├── 01_APPRO/               ✅ BIB_CDM.txt
    │   └── 02_TRAITEMENT/          ✅ BIPREGEN + ANGIPREGEN + PROCESS_BIB + POOLS_CDM.txt
    │
...
| Document | Rôle |
|---|---|
| `_LIGNES/_CDM/01_APPRO/BIB_CDM.txt` | Base Items Brute CDM |
| `_LIGNES/_CDM/02_TRAITEMENT/BIPREGEN_CDM.txt` | Items codés + niveaux harmonisés |
| `_LIGNES/_CDM/02_TRAITEMENT/ANGIPREGEN_CDM.txt` | Angles interrogeables + quotas |
| `_LIGNES/_CDM/02_TRAITEMENT/PROCESS_BIB_CDM.md` | Traçabilité BIB → BIPREGEN |
| `_LIGNES/_CDM/02_TRAITEMENT/POOLS_CDM.txt` | Définition des 20 pools — chaînon vers génération |
...
| `_STANDARDS/glossaire_documentaire_factory.md` | Définitions des concepts documentaires — couche d'interprétation IA |
| `_STANDARDS/FACTORY_QA_RULES.md` | Contrôles qualité obligatoires (CHECK codes) + flags QA |
| `_STANDARDS/RULE_PRIORITY_MATRIX.md` | Hiérarchie des règles : HARD_BLOCKER / SOFT_WARNING / OPTIONAL |
| `_STANDARDS/QUIZ_ASSEMBLY_RULES.md` | Ordre des 20 questions + règles anti-monotonie + équilibrage |
